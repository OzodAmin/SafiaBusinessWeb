    ...
    <ul class="nav nav-tabs">
        ...
        <li>
            <a href="#tab_base" data-toggle="tab">
                <span class="locale-title text-warning"><i class="fa fa-align-center" aria-hidden="true"></i> Основа</span>
            </a>
        </li>
        <li>
            <a href="#tab_cover" data-toggle="tab">
                <span class="locale-title text-info" ><i class="fa fa-align-center" aria-hidden="true"></i> Покрытие</span>
            </a>
        </li>
        <li>
            <a href="#tab_cream" data-toggle="tab">
                <span class="locale-title text-success"><i class="fa fa-align-center" aria-hidden="true"></i> Крема и муссы</span>
            </a>
        </li>
        <li>
            <a href="#tab_decor" data-toggle="tab">
                <span class="locale-title text-primary"><i class="fa fa-align-center" aria-hidden="true"></i> Оформление</span>
            </a>
        </li>
        <li>
            <a href="#tab_filling" data-toggle="tab">
                <span class="locale-title text-danger"><i class="fa fa-align-center" aria-hidden="true"></i> Начинки</span>
            </a>
        </li>
    </ul>
