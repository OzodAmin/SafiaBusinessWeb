    ...
    <div class="tab-content">
        ...
        <div class="tab-pane {{ $key==1 ? 'active' : '' }}" id="tab_{{ $key }}">
            ...
            <div class="form-group col-sm-6">
                ...
                {{ Form::text(
                    $locale.'[title]',
                    isset($filling) ? $filling->translate($locale)->title : null,
                    ['class' => 'form-control'])
                }}
            </div>
            ...
            <div class="form-group col-sm-6">
                ...
                {{ Form::text(
                    $locale.'[slug]',
                    isset($filling) ? $filling->translate($locale)->slug : null,
                    ['class' => 'form-control',
                    'disabled' => isset($filling) ? null : 'true'])
                }}
            </div>
            ...
            <div class="form-group col-sm-12">
                ...
                <a href="{!! route('fillings.index') !!}" class="btn btn-default">Cancel</a>
            </div>
